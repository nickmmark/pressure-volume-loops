...
### VA-ECMO
Venoarterial extracorporeal membrane oxygenation (VA-ECMO) provides variable hemodynamic support depending on the pump RPM/flow rate.
VA-ECMO causes a rightward and upward shift of the left ventricular (LV) pressure-volume (PV) loop, increasing end-diastolic volume/pressure and systolic pressure due to high afterload from retrograde arterial flow. Although VA-ECMO can provide more liters/minute of hemodynamic support, it has some detrimental effects such as increasesd LV wall tension, oxygen consumption (PVA), and causes ventricular distension, as the LV pumps against a closed or nearly closed aortic valve. 

Key Effects on PV Loops: 
